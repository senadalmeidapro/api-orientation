...
export class AdaptiveUtil {
  ...
  static calculateQuestionScore(
    ...
    const finalScore = cfg.profileWeight * relevanceScore + cfg.diversityWeight * diversityScore;
  ...
  static selectTopQuestions(
    ...
    for (const question of scoredQuestions) {
      ...
      const hasNewProfile = question.profiles.some((p) => !selectedProfiles.has(p.riasecType));
