...
- Analyser et valider qu'un utilisateur a bien le droit de démarrer une phase avancée (_ex: a-t-il terminé PHASE 1 avant de commencer PHASE 2 OCCUPATIONS ?_)
