...
import { BadgeRarity, CareerCategory, type Prisma, type RiasecType } from '@prisma/client';
...
const enhancedCareers: CareerSeed[] = [
...

    {
        ...
        careerPath:
            'Junior Dev → Developer → Senior Dev → Tech Lead → Freelancer / Start-up Founder',
        isFeatured: true,
        isActive: true,
...

    {
        ...
        salaryRangeMax: 2500000,
        careerPath:
            'Enseignant titulaire → Enseignant principal → Inspecteur / Directeur / Formateur',
        isFeatured: true,
        isActive: true,
...
// ============================================================
// ENHANCED BADGES DATA (14 entries with all fields)
// ============================================================
...
const enhancedBadges: BadgeSeed[] = [
...

    {
        ...
        name: 'Unique',
        description:
            'Ton profil est original et sort des sentiers battus ! Bravo pour ta singularité.',
        emoji: '🦄',
        rarity: BadgeRarity.LEGENDARY,
        pointsValue: 120,
        unlockCondition: {
            type: 'differentiation_score',
            minScore: 0.8,
        },
    },
...
// ============================================================
// UNIVERSITIES & SCHOLARSHIPS SEEDING
// ============================================================
// NOTE: Universities and Scholarships seeding moved to dedicated seeders
// This section was previously used for Link Categories which have been
// refactored to the Universities module
...
export async function seedEnhancedData(prisma: PrismaService) {
    try {
        await seedEnhancedCareers(prisma);
        await seedEnhancedBadges(prisma);
        // seedEnhancedLinkCategories removed - replaced with universities model
